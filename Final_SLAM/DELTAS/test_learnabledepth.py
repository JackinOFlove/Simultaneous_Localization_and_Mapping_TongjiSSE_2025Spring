...
parser.add_argument('--data', default='./assets/SUN3D_Data/scannet_sample', type=str, metavar='DIR',
...
parser.add_argument('--ttype2', default='./assets/SUN3D_Data/scannetv2_test.txt', type=str, help='Text file indicates input data')
...
parser.add_argument('--seq_length', default=7, type=int, help='length of sequence')
